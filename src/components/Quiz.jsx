            ...
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-8">
                        <div className="card p-4" style={{ background: 'transparent', backdropFilter: 'blur(25px)', borderColor: '#646464' }}>
                            ...
                            <div>
                                {
                                    ...
                                    <button
                                        key={index}
                                        className={`option w-100 text-start btn py-2 px-3 mt-3 rounded btn-dark ${correctAnswer === item && 'bg-success'}`}
